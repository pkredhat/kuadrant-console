...
# Default to the origin-console image. If quay.io is unreachable, override with:
#   CONSOLE_IMAGE=registry.redhat.io/openshift4/ose-console-rhel9:v4.19 ./start-console.sh
CONSOLE_IMAGE=${CONSOLE_IMAGE:="quay.io/openshift/origin-console:latest"}
CONSOLE_PORT=${CONSOLE_PORT:=9000}
CONSOLE_IMAGE_PLATFORM=${CONSOLE_IMAGE_PLATFORM:="linux/amd64"}

PLUGIN_NAME=${npm_package_consolePlugin_name:-kuadrant-console}
